...
class music_cog(commands.Cog):
    ...
    @commands.command(name="pause", help="Pause the music playing")
    async def pause(self, ctx):
        if self.vc != "" and self.vc:
            if self.vc.is_playing():
                self.vc.pause()

    @commands.command(name="resume", help="Resume the music paused")
    ...
    @commands.command(name='stop', help="stop the queue")
